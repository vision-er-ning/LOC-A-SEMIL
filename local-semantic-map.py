...
rects1 = ax.bar(index, y_SEMIL_without_semantic_map, bar_width,alpha=0.8,
                color='darkgreen',
                error_kw=error_config,
                label='VISEL_Floor Map')

rects2 = ax.bar(index + bar_width, y_SEMIL, bar_width,alpha=0.8,
                color='maroon',
                error_kw=error_config,
                label='VISEL')
...
plt.savefig("localization_semantic map.png", dpi = 500)
plt.show()
